...
$menu->settings->isAllowed(\app\Models\User::find(501)); // Check if an item is available for a given user
```
...
$item->childrenAllowed(\app\Models\User::find(123)); // Returns the allowed items for the given user
```
